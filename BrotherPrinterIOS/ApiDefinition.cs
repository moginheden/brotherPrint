...
namespace BRPtouchPrintKitW
{
    ...
    [BaseType(typeof(NSObject))]
    public interface BRPtouchPrinter
    {
        [Export("initWithPrinterName:type:")]
        IntPtr Constructor(string strPrinterName, CONNECTION_TYPE type);

        [Export("setPrinterName:")]
        bool setPrinterName(string strPrinterName);

        [Export("setIPAddress:")]
        bool setIPAddress(string strIP);
    }
